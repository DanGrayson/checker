...
Definition LF simple_λ_object
	   ...
	   : (T:a_type) ⟶ 
	     (U:a_type) ⟶ 
	     (body : (t:obj_of_type T) ⟶ obj_of_type U) ⟶ 
	     obj_of_type (arrow_type T U) 
...
Theorem LF compose3 : (u:uexp) ⟶ 
		      (T : obj_of_type (U_type u)) ⟶ 
		      (U : obj_of_type (U_type u)) ⟶ 
		      (V : obj_of_type (U_type u)) ⟶ 
