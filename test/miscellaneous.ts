...
Check Judgment LF ∏ x:oexp, ∏ y:oexp, ∏ T:texp, ∏ U:texp, [ x ≡ y : T ]⟶[ T ≡ U ]⟶[ x ≡ y : U ];;
...
Check Judgment LF texp ** oexp ;;
Check LF      (pair (UU u0) (uu u0));;
Check Judgment LF Sigma x: uexp, texp;;
Check LF      (pair u0 (UU u0));;
Check Judgment LF Singleton ( (pair u0 (UU u0)) :  (Sigma x: uexp, texp) );;
# Show;;
