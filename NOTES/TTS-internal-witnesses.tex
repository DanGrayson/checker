...
\item 
\[\inferrule
    {\Gamma \vdash p\hastype o_1\equality o_2 \hastype q : T_1 \equality T_2}
    {\Gamma \vdash \ha\wsymm{p}\hastype o_2\equality o_1 \hastype \ha\Wsymm{q} : T_2 \equality T_1}\]
...
\[\inferrule{\Gamma \vdash p\hastype o_1\equality o_2 \hastype T_1 \equality T_2
  ...
  \Gamma \vdash \ha\wtrans{p,T_2,o_2,q}\hastype o_1\equality o_3 \hastype \ha\Wtrans{p,T_2,q} : T_1 \equality T_3}
\]
