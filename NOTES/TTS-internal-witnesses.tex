...
$$ [ x_1 : T_1 , \dots , x_m : T_m, y_1 \defn u_1 : U_1 , \dots , y_n \defn u_n
  : U_n ],$$ which is convenient, because of its compact form, without multiple
...
provided we regard variables with defined values as mere annotations, rather than as coordinates
with specified values.  Putting definitional equalities into the context, as we do, allows us
