...
and tfillin env (pos,t) = with_pos pos (
  ...
  | T_Coprod2 (t,t',(x,u),(x',u'),o) 
    -> T_Coprod2 (tfillin env t,tfillin env t',tfillin_binder env (x,u),tfillin_binder env (x',u'),ofillin env o)
  | T_Empty -> t
...
and ofillin env ((pos:position),o) = with_pos pos (
  ...
  | O_c (tA,a,(x,tB,(y,tD,(z,q))),b,f) 
    -> O_c (tfillin env tA,ofillin env a,ttofillin_binder env (x,tB,(y,tD,(z,q))),ofillin env b,ofillin env f)
  ...
  | O_ic (m1,m2,m3,oA,a,(x,oB,(y,oD,(z,q)))) 
    -> O_ic (m1,m2,m3,ofillin env oA,ofillin env a,ooofillin_binder env (x,oB,(y,oD,(z,q))))
  ...
  | O_J (tT,a,b,q,i,(x,e,tS)) 
    -> O_J (tfillin env tT,ofillin env a,ofillin env b,ofillin env q,ofillin env i,t2fillin_binder env (x,e,tS))
