...
Axiom 6.3.1 Σ_istype { ⊢ T Type } { t : T ⊢ U Type } ⊢ [Σ](T,U) Type .

Axiom 6.3.2 pair_hastype { ⊢ T1 Type } { x : T1 ⊢ T2 Type } { ⊢ o1 : T1, o2 : T2/o1 } ⊢ [pair](o1,o2,T2) : [Σ](T1,T2).

Axiom 6.3.3 pr1_hastype { ⊢ T1 Type } { x : T1 ⊢ T2 Type } { ⊢ a : [Σ](T1,T2) } ⊢ [pr1](T1,T2,a) : T1.
