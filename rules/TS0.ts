...
Axiom 3.4.25 ev_hastype { ⊢ T Type } { t : T ⊢ U Type } { ⊢ f : ∏ t:T, U[t], o : T } ⊢ @[ev;t][f,o,U[t]] : U[o].
...
Axiom 3.4.29 jj_hastype { ⊢ M1 M2 Ulevel } [ umax[M1,M2] ~ M2 Ulevel ] ⇒ [ jj[M1,M2] : UU[M1] -> UU[M2] ].
